...
> [TODO]{style="color:red;font-weight:bold"}: *Generally, a good Kappa value is \> 0.6.*

## 7. Improvement

How can we interpret the confusion matrix, and how can we improve in our predictions?

> [TODO]{style="color:red;font-weight:bold"}: *The diagonals (starting from top left to bottom right) of our matrix are the values that have been correctly predicted. The others are incorrect predicted. Our kappa was 34.4% and there is an accuracy of around 60.6% with a 95% confidence intervals of 58.2% to 62.9%. One way we can try to improve our predictions is to make sure data from the different provinces are equal, meaning maybe we get 200 samples from each. This would help with consistency and could help our model more accurately classify. We could also potentially make our k smaller but then it might over fit.*
